...
<aside id="colorlib-hero">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
                                <div class="slider-text-inner text-center">
                                    ...
                                    <!-- <h2><span><a href="{{route('index')}}">Home</a> | Courses</span></h2> -->
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
                        <h2>"{{$detail->category}}" kategoriyasina aid kurslarımız</h2>
                      
                    </div>
                </div>
                <div class="row">
                    @foreach($detail->courses as $c)
        ...
        <div id="colorlib-subscribe" class="subs-img" style="background-image: url({{asset($c->sekil)}});" data-stellar-background-ratio="0.5">
            <div class="overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
