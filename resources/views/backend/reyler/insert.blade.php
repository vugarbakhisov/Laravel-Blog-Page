            				...
            				<div class="card">
            					<div class="card-body">
            						...
            						<div class="basic-form">
            							<form method="POST" action="{{route('reyler.insert.save')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                                              ...
                                              <div class="form-group">
                                                   <input type="text" name="name" placeholder="." class="form-control input-rounded" />
                                             </div>
                                               
 </div>
                                             <h4 class="card-title">Məzmun</h4>
                                             <div class="form-group">
                                                   <textarea class="form-control" rows="15" name="comment" placeholder="Məzmun daxil edin..."></textarea>
                                             </div>
